...
{
    static POST_DISEASE_URL = '/api/disease';
    ...
    postDisease() {
        axios({
            ...
            url: process.env.REACT_APP_API_URI + Add.POST_DISEASE_URL,
            headers: {
                "Authorization": "Bearer " + getToken().token,
                "Content-Type": "application/json",
            }
        }).then(res => {
            toast['success']('Le maladie a bien été ajouté !');
            this.props.history.push('/maladies')
        }).catch(error => {
        ...
        <Fragment>
            <ReactCSSTransitionGroup
                ...
                <Card className="main-card mb-3">
                    <CardBody>
                        <CardTitle>Nouveau maladie</CardTitle>
