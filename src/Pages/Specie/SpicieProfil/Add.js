...
{
    static POST_SPECIE_URL = '/api/specie';
    ...
    postSpecie() {
        axios({
            method: 'POST',
            data: this.state.specie,
            url: process.env.REACT_APP_API_URI + Add.POST_SPECIE_URL,
            headers: {
        ...
        <Fragment>
            <ReactCSSTransitionGroup
                ...
                <Card className="main-card mb-3">
                    <CardBody>
                        <CardTitle>Nouvelle espèce</CardTitle>
